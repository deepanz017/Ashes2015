...
<div class="page-header">
    <h1>"label.user.registration.page.title"</h1>
</div>
<!--
            ...
            <form:form action="${pageContext.request.contextPath}/user/register" commandName="user" method="POST" enctype="utf8" role="form">
                ...
                <div class="row">
                    <div id="form-group-firstName" class="form-group col-lg-4">
                        <label class="control-label" for="user-firstName">"label.user.firstName":</label>
                        <!--
                ...
                <div class="row">
                    <div id="form-group-lastName" class="form-group col-lg-4">
                        <label class="control-label" for="user-lastName">"label.user.lastName":</label>
                        <!--
                ...
                <div class="row">
                    <div id="form-group-email" class="form-group col-lg-4">
                        <label class="control-label" for="user-email">"label.user.email":</label>
                        <!--
                ...
                <c:if test="${user.signInProvider == null}">
                    <div class="row">
                        <div id="form-group-password" class="form-group col-lg-4">
                            <label class="control-label" for="user-password">"label.user.password":</label>
                            <!--
                    ...
                    <div class="row">
                        <div id="form-group-passwordVerification" class="form-group col-lg-4">
                            <label class="control-label" for="user-passwordVerification">"label.user.passwordVerification":</label>
                            <!--
...
<sec:authorize access="isAuthenticated()">
    <p>"text.registration.page.authenticated.user.help"</p>
</sec:authorize>
</body>
</html>