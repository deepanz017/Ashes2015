...
//            dickyPicks.add(playerService.getPlayersInMatch().getPlayerObjectsInMatch().get(3067));//Clarke
//            dickyPicks.add(playerService.getPlayersInMatch().getPlayerObjectsInMatch().get(4818));//Hazlewood
